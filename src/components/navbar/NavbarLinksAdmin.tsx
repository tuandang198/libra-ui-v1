...
export default function HeaderLinks(props: {
  ...
  useEffect(() => {
	const fetchUserInfo = async () => {
		try {
		  const response = await axiosInstance.get<BaseResponse<UserResponse>>(ME).then((res) => {
			const user: UserResponse = res.data.result;
			setUserInfo(user);
		  });
		} catch (error) {
		  console.error(error);
          ...
          <Menu>
            ...
            <MenuButton p="0px" style={{ position: 'relative' }}>
              ...
              >
				...
				{userInfo?.user.username.substring(0, 2).toUpperCase()}
                </Text>
              </Center>
            </MenuButton>
            <MenuList
            ...
            >
              <Flex w="100%" mb="0px">
                <Text
                  ...
                  color={textColor}
                >
                  👋&nbsp; Xin chào {userInfo?.user.fullname}
                </Text>
              </Flex>
